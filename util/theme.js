import { parseToHsla, transparentize, hsla, saturate, desaturate } from 'color2k';
...
export const makeTheme = userTheme => ({
  ...chakraTheme,
  colors: { ...chakraTheme.colors, ...importColors(userTheme.colors) },
  fonts: { ...chakraTheme.fonts, ...importFonts(userTheme.fonts) },
  fontWeights: {
    light: 200,
    normal: 400,
    semibold: 600,
